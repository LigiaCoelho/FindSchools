...
<html>
    <head>
        ...
        <style>
            ...
            <body>
            <h1>Pré-Matrícula Realizada com Sucesso!</h1>
            ...
            $query = "UPDATE tb_pessoa SET protocolo = :protocolo WHERE cpf_resp = :cpf_resp;";
             $stmt = $conn->prepare($query);
             $stmt->bindParam(':protocolo', $protocolo, PDO::PARAM_STR);
             $stmt->bindParam(':cpf_resp', $_GET['cpf_resp'], PDO::PARAM_STR);
             $stmt->execute();
             
            echo "<h2><b>Protocolo:&nbsp;".$protocolo."</b></b><h2>";
