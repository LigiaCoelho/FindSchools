...
LOCK TABLES `tb_escolas` WRITE;
/*!40000 ALTER TABLE `tb_escolas` DISABLE KEYS */;
INSERT INTO `tb_escolas` VALUES (32,'Escola X',2147483647,'teste',0,''),(33,'Escola X',2147483647,'teste',0,''),(34,'Escola X',2147483647,'teste',0,'30');
/*!40000 ALTER TABLE `tb_escolas` ENABLE KEYS */;
UNLOCK TABLES;
